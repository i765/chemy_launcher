<script lang="ts">
  ...
  import { GetAvailablePorts } from "../wailsjs/go/main/App";
  ...
  async function refreshPorts() {
    try {
      ...
      alert("Не удалось получить порты " + err);
    }
  }
...
<main>
  <div class="header">
    <div class="title">Запускатор</div>
  ...
  <div class="run-form">
    ...
    <div class="input-box">
      <button>Старт</button><button>Имитатор УСО</button><button
        >Конфигурация</button
      >
    </div>
  </div>
